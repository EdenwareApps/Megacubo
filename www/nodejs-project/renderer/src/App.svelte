...
:root {
    ...
    --menu-height: calc(100vh - 1vmin - var(--menu-padding-top) - var(--menu-padding-bottom));
    --entries-per-row: 2;
    --entries-per-col: 2;
    ...
    --menu-padding-right: 1vmin;
    --menu-padding-left: 1vmin;
    ...
    --controls-height: calc(var(--menu-entry-name-font-size) * 3.575);
