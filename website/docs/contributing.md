...
- **Internal Modules**: Check out the [Internal Modules Documentation](https://github.com/EdenwareApps/Megacubo/blob/main/www/nodejs/modules/README.md) to understand how the different components work together
...
3. **Prepare the project** (compiles and bundles the code):
   ...
   npm run prepare
   ```
   See [development setup](developing.md#prerequisites) for more details.
