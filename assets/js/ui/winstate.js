...
function restoreWindowState() {
    ...
    if(winState.width > 300 && winState.height > 300){
    ...
    if (!locationIsOnAScreen) {
        console.log("[winstate] Last saved position of windows is not usable on current monitor setup. Moving window to center!", winState);
        win.setPosition("center")
    }
    else {
