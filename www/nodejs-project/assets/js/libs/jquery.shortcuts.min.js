...
(function($) {
    ...
    var special = {
        ...
        'f12': 123,
        '?': 191, // Question mark
        'minus': window.opera ? [109, 45] : (typeof InstallTrigger !== 'undefined') ? 109 : [189, 109],
        'plus': window.opera ? [61, 43] : (typeof InstallTrigger !== 'undefined') ? [61, 107] : [187, 107],
        'pause': 19,
        'browserback': 166,
        'browserforward': 167,
        'browserrefresh': 168,
    ...
    var getMaskObject = function(mask) {
        ...
        $.each(items, function(i, item) {
            if (item === 'ctrl' || item === 'alt' || item === 'shift') {
                ...
                obj.which = special[item] || (isNumeric(item) ? item : item.toUpperCase().charCodeAt());
            }
        });
    ...
    var checkIsInput = function(target) {
        ...
        return (name === 'input' && $.inArray(type, ['text', 'password', 'file', 'search', 'range']) > -1) || name === 'textarea';
    };
    ...
    $.Shortcuts.start = function(list) {
        ...
        $(document).on((window.opera ? 'keypress' : 'keydown') + '.shortcuts', function(e) {
