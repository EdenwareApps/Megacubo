...
[🏠](/docs/introduction) > [User Guide](introduction.md) > Hotkeys

### Default hotkeys in Megacubo:
<br />

Below is a list of keyboard shortcuts available for use in Megacubo. To learn more about the [app's configuration options, click here](https://github.com/EdenwareApps/Megacubo/blob/master/docs/configuring.md).<br /><br />
...
- **[Watching Live TV](watching-live-tv.md)** - How to watch content

---

[🏠](/docs/introduction) | [User Guide](introduction.md) | [Configuring](configuring.md)
