if(typeof(require) != 'undefined') { // ReferenceError: require is not defined
    ...
    class P2PManager extends P2PSegmentTools {
        constructor(sock, addr, maxPeers){
            ...
            this.app.on('download-p2p-fetch-request', r => {
                if(r.url){
        ...
        bind(peer, id){
            ...
            this.peers[id].on('data', this.peerListeners[id] = message => {
