...
body:not(.video).miniplayer-cordova div#paused-layer {
...
body.audio:not(.miniplayer-cordova):not(.menu-playing) controls,
body.casting:not(.menu-playing) controls,
body.video.video-playing:not(.idle):not(.menu-playing):not(.miniplayer-cordova) controls,
body.video.video-paused:not(.miniplayer-cordova):not(.menu-playing) controls,
body.video.video-ended:not(.miniplayer-cordova):not(.menu-playing) controls,
body.video.video-loading:not(.miniplayer-cordova):not(.menu-playing):not(.idle) controls {
    bottom: 0;
    transform: none;
}
...
body.miniplayer-cordova controls,
body.miniplayer-cordova div#modal,
body.miniplayer-cordova #menu header {
    display: none !important;
}

body.miniplayer-cordova div#paused-layer {
    padding: 0;
}
