...
See [contributing guide](contributing.md#iptv-development-requirements) for system requirements.
...
[🏠](/docs/introduction) | [Building](building.md) | [Contributing](contributing.md)Any errors along the way? [Let us know](https://github.com/EdenwareApps/Megacubo/issues).
