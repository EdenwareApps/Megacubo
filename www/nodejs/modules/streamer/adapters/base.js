...
class StreamerAdapterBase extends EventEmitter {
    ...
    downloadLogCalc() {
        ...
        if (ks.length) {
            ...
            /*
            if(this.opts.debug){
                console.log('[' + this.type + '] download speed:', downloaded, now, ftime, speed, kbsfmt(speed) + ((this.bitrate) ? ', required: ' + kbsfmt(this.bitrate): ''))
            }
            */
...
export default StreamerAdapterBase;
