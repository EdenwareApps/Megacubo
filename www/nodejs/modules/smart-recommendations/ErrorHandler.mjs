...
export class ErrorHandler {
  ...
  static debug(message, data = null) {
    if (this.debugMode) {
      console.log(`🔍 Smart Recommendations: ${message}`)
      if (data !== null) {
        try {
  ...
  static info(message, data = null) {
    console.log(`ℹ️ Smart Recommendations: ${message}`)
  ...
  static warn(message, data = null) {
    this.warningCount++
    console.warn(`⚠️ Smart Recommendations: ${message}`)
    if (data) {
      try {
  ...
  static error(message, error = null) {
    this.errorCount++
    console.error(`❌ Smart Recommendations: ${message}`)
    if (error) {
